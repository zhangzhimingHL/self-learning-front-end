<template>
  <div class="js-page">
    <header class="hero">
      <h1>进阶运算合集</h1>
      <p class="hero-sub">面试必考 · <span class="kw">大数相加</span> · <span class="kw">版本号对比</span> · <span class="kw">LRU 缓存</span></p>
    </header>
    ...
    <section id="s1-bigint" class="section-card">
      <h2 class="s-title">一、大数相加/相乘 <span class="s-badge">腾讯/字节高频</span></h2>
      <p class="s-desc">建设中，敬请期待...</p>
    </section>

    <section id="s2-version" class="section-card">
      <h2 class="s-title">二、版本号对比 <span class="s-badge">腾讯高频</span></h2>
      <p class="s-desc">建设中，敬请期待...</p>
    </section>

    <section id="s3-lru" class="section-card">
      <h2 class="s-title">三、LRU 缓存 <span class="s-badge">字节高频</span></h2>
      <p class="s-desc">建设中，敬请期待...</p>
    </section>
  </div>
</template>
...
const toc = [
  { id: 's1-bigint',  label: '大数相加' },
  { id: 's2-version', label: '版本号对比' },
  { id: 's3-lru',     label: 'LRU 缓存' },
]
</script>
